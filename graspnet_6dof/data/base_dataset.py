...
from graspnet_6dof.utils.sample import Object
from graspnet_6dof.utils import utils
from graspnet_6dof.renderer.online_object_renderer import OnlineObjectRenderer
...
class BaseDataset(data.Dataset):
    ...
    def read_grasp_file(self, path, return_all_grasps=False):
        """Get the grasps and the cad (CAD model?)

        Args:
            path (_type_): _description_
            return_all_grasps (bool, optional): _description_. Defaults to False.
    ...
    def read_object_grasp_data(self,
        ...
        #### Below is loading the object model. comment since the data is not ready
