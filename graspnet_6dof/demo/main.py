...
from graspnet_6dof.utils.visualization_utils import *
...
def make_parser():
    ...
    parser.add_argument('--grasp_evaluator_folder',
                        type=str,
                        default='./graspnet_6dof/checkpoints/evaluator_pretrained/')
    parser.add_argument('--refinement_method',
                        choices={"gradient", "sampling"},
                        default='sampling')
    parser.add_argument('--refine_steps', type=int, default=25)

    parser.add_argument('--npy_folder', type=str, default='./graspnet_6dof/demo/data/')
    parser.add_argument(
        '--threshold',
        type=float,
        default=0.8,
...
def backproject(depth_cv,
    ...
    """Get the camera-frame point cloud from the depth image"""
